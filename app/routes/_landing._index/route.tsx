        ...
        <div className="relative container mx-auto px-4 py-10 lg:py-20">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="max-w-4xl mx-auto">
              <div className="relative rounded-2xl overflow-hidden shadow-2xl border border-gray-200/50 dark:border-gray-700/50 bg-white/10 dark:bg-gray-800/10 backdrop-blur-sm">
                <img
                  src="/ogp-image.png"
                  alt="MangaLog App Preview"
      ...
      <div className="container mx-auto px-4 py-20">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="order-2 lg:order-1">
            <div className="relative rounded-2xl overflow-hidden shadow-2xl border border-gray-200/50 dark:border-gray-700/50 bg-white/10 dark:bg-gray-800/10 backdrop-blur-sm">
              <img
                src="/images/add-new-manga.png"
                alt="Add New Manga Feature"
                className="w-full h-auto"
                loading="lazy"
              />
          ...
          <div className="order-1 lg:order-2">
            <div className="inline-flex items-center gap-2 bg-purple-100 dark:bg-purple-900/30 rounded-full px-4 py-2 mb-6">
              <BookOpen className="w-4 h-4 text-purple-600 dark:text-purple-400" />
              <span className="text-sm font-medium text-purple-700 dark:text-purple-300">Easy to Use</span>
            </div>
            <h3 className="text-3xl lg:text-4xl font-bold text-gray-900 dark:text-white mb-6">
              Add manga in seconds
            </h3>
            <p className="text-lg text-gray-600 dark:text-gray-300 mb-8 leading-relaxed">
              Our intuitive interface makes it effortless to log new manga. Simply enter the title,
              add your rating, track your progress, and include personal notes. Everything you need
              in one clean, organized form.
            </p>
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                <div className="w-2 h-2 bg-purple-500 rounded-full" />
                <span className="text-gray-700 dark:text-gray-300">Quick title entry with smart suggestions</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-2 h-2 bg-purple-500 rounded-full" />
                <span className="text-gray-700 dark:text-gray-300">Flexible rating system (0.0 - 5.0 stars)</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-2 h-2 bg-purple-500 rounded-full" />
                <span className="text-gray-700 dark:text-gray-300">Volume and chapter progress tracking</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-2 h-2 bg-purple-500 rounded-full" />
                <span className="text-gray-700 dark:text-gray-300">Personal notes for future reference</span>
              </div>
            </div>
          </div>
        </div>
